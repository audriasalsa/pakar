			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="active open">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo site_url('TabelPenyakit') ?>">
							...
							<li class="">
								<a href="<?php echo site_url('TabelGejala') ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Tabel Gejala
								</a>
							...
							<li class="">
								<a href="<?php echo site_url('TabelPasien') ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Tabel Pasien
								</a>
								<b class="arrow"></b>
							...
							<li class="">
								<a href="<?php echo site_url('Metode') ?>">
									<i class="menu-icon fa fa-caret-right"></i>
									Metode
								</a>
								<b class="arrow"></b>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Pakar</span>
							Penyakit Ginekologi &copy; 2020
						</span>
					</div>
				</div>
			</div>
